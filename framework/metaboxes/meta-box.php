...
class RW_Meta_Box {
	...
	static function js_css() {
		...
		wp_enqueue_style('iphone-style', $base_url . '/../admin/css/admin-style.css');
		wp_enqueue_script('rw-meta-box', $base_url . '/meta-box.js', array('jquery'), null, true);
		wp_enqueue_script('iphone-js', $base_url . '/../admin/js/iphone-style-checkboxes.js', array('jquery'), null, true);
	}
