...
//Hovers images
$('.cat_article_img img, .widget .flickr_badge_wrapper a, .news_box .recent_news_img, .recent-news-img img, .mom_posts_images img, ul.blog_posts_widget li img, .lates_video_item img, .sidebar .ads125 img, .related_image, .nb2_next2_img img').hover( function() {
...
//Images
	$(".single_article_content a .size-medium, .single_article_content a .size-large, .single_article_content a .size-thumbnail, .single_article_content a .size-full").parent().addClass('lightbox_img');
